...
class QuestionBankPolicy
{
    ...
    public function update(User $actor, QuestionBank $category): bool
    {
    ...
    public function delete(User $actor, QuestionBank $category): bool
    {
        if (! $this->sameTenant($actor, $category)) {
            return false;
        }
    ...
    private function sameTenant(User $actor, QuestionBank $category): bool
    {
